# Generated by Powerlevel10k configuration wizard on 2024-05-21 at 00:44 UTC.
...
() {
  ...
  #  pyenv                   # python environment (https://github.com/pyenv/pyenv)
   ...
   # fvm                     # flutter version management (https://github.com/leoafarias/fvm)
    ...
    #vnix_shell               # nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html)
    #vchezmoi_shell           # chezmoi shell (https://www.chezmoi.io/)
